...
import com.project.flygifttest.R;
...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    public SwipeFlingAdapterView(Context context, AttributeSet attrs, int defStyle) {
        ...
        xOffsetStep = a.getDimensionPixelOffset(R.styleable.SwipeFlingAdapterView_x_offset_step, 0);
        a.recycle();
    }
...
//                removeAllViewsInLayout();
    ...
    private void adjustChildView(View child, int index) {
        if(index > -1 && index < MAX_VISIBLE){
            ...
            child.offsetLeftAndRight(xOffsetStep * multiple);
...
//                underTopView.offsetTopAndBottom(offset - underTopView.getTop() + initTop);
                ...
                int offset = (int) (xOffsetStep * (multiple- rate));
//                underTopView.animate().setDuration(200)
//                        .setInterpolator(new AccelerateDecelerateInterpolator())
//                        .translationX(offset - underTopView.getLeft() + initLeft)
//                        .scaleX(1- multiple + rate)
//                        .scaleY(1- multiple + rate)
//                        .start();
    ...
    */
    ...
    public interface onFlingListener {
        ...
        void onScroll(float progress, float scrollProgressPercent);
    }
